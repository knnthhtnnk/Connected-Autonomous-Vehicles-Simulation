...
% u0(:,1)=0;
% u1(:,1)=-((x1(:,1)-r1)-(x0(:,1)-r0));
% u2(:,1)=-(2*((x2(:,1)-r2)-(x1(:,1)-r1)));
% u3(:,1)=-(4*((x3(:,1)-r3)-(x2(:,1)-r2)));
% u4(:,1)=-((x4(:,1)-r4)-(x3(:,1)-r3));
% u5(:,1)=-((x5(:,1)-r5)-(x4(:,1)-r4));
% u6(:,1)=-(3*((x6(:,1)-r6)-(x5(:,1)-r5)));
...
%     u1(:,1)=-((x1(:,k)-r1)-(x0(:,k)-r0));
%     u2(:,1)=-(2*((x2(:,k)-r2)-(x1(:,k)-r1)));
%     u3(:,1)=-(4*((x3(:,k)-r3)-(x2(:,k)-r2)));
%     u4(:,1)=-((x4(:,k)-r4)-(x3(:,k)-r3));
%     u5(:,1)=-((x5(:,k)-r5)-(x4(:,k)-r4));
%     u6(:,1)=-(3*((x6(:,k)-r6)-(x5(:,k)-r5)));
...
title({"Vehicles' Displacements over Time";"Normal"})
...
title({"Vehicles' Velocities over Time";"Normal"})
xlabel('Time (second)','Fontname', 'Times New Roman','fontsize',10)
...
title({"Vehicles' Accelerations over Time";"Normal"})
xlabel('Time (second)','Fontname', 'Times New Roman','fontsize',10)
...
title({"Vehicles' Locations over Time";"Normal"})
xlabel('Time (second)','Fontname', 'Times New Roman','fontsize',10)
...
title({"Vehicles' Spacing over Time";"Normal"})
xlabel('Time (second)','Fontname', 'Times New Roman','fontsize',10)
...
title({"Vehicles' Errors over Time";"Normal"})
axis tight
